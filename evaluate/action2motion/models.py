...
class MotionDiscriminator(nn.Module):
    ...
    def forward(self, motion_sequence, lengths=None, hidden_unit=None):
        ...
        if hidden_unit is None:
            ...
            hidden_unit = self.initHidden(motion_sequence.size(1), self.hidden_layer).to(device)
...
classifier_model_files = {
    "ntu13": "lib/actionrecognition/ntu13_gru.tar",
    "humanact12": "lib/actionrecognition/humanact12_gru.tar",
    "uestc": "lib/actionrecognition/uestc_xyz_gru.tar",
    "cmu": "lib/actionrecognition/action_recognition_model_mocap_new.tar",
}
