...
JOINT_REGRESSOR_TRAIN_EXTRA = "./lib/smpl/J_regressor_extra.npy"
SMPL_MODEL_PATH=os.path.join(PROJECT_ROOT_DIR,SMPL_MODEL_PATH)
JOINT_REGRESSOR_TRAIN_EXTRA=os.path.join(PROJECT_ROOT_DIR,JOINT_REGRESSOR_TRAIN_EXTRA)
...
class SMPL(_SMPLLayer):
    ...
    def forward(self, *args, **kwargs):
        ...
        #print(smpl_output.body_pose.shape)
