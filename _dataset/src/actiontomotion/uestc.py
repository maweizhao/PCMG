...
from _dataset.src.actiontomotion.dataset import Dataset
...
class UESTC(Dataset):
    ...
    def __init__(self, datapath="C:/usersdata/maweizhao/dataset/uestc", method_name="vibe", view="all", **kargs):
...
if __name__ == "__main__":
    #dataset = UESTC(num_frames=60,split="train")
    dataset = UESTC(num_frames=60,split="train")
