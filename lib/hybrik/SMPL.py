...
class SMPL_layer(nn.Module):
    ...
    NUM_BETAS = 10
    JOINT_NAMES = [
        'pelvis', 'left_hip', 'right_hip',      # 2     0,1,2
        'spine1', 'left_knee', 'right_knee',    # 5     3,4,5
        'spine2', 'left_ankle', 'right_ankle',  # 8     6,7,8
        'spine3', 'left_foot', 'right_foot',    # 11    9,10,11
        'neck', 'left_collar', 'right_collar',  # 14    12,13,14  
        'jaw',                                  # 15    15
        'left_shoulder', 'right_shoulder',      # 17    16,17
